...
{/* API Status */}
 ...
 {showMemoryPanel && connected && memory && (
  <div style={{position:'fixed',right:'320px',top:'10px',width:'380px',zIndex:100,maxHeight:'80vh',overflowY:'auto',padding:'10px',background:'rgba(0,0,0,0.95)',border:'2px solid rgba(255,42,109,0.3)',borderRadius:'10px',boxShadow:'0 0 30px rgba(0,0,0,0.8)'}}>
