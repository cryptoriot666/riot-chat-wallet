...
// Remove import widgets line
c = c.replace(/import \{ TaskTracker, DraftWriter, WidgetTabs, EncryptModal \} from ['"].\/widgets['"];?\n?/, '');

// Find 'export default function App'
const appIdx = c.indexOf('export default function App');

// Use const arrow function assignment instead of function keyword
const defs = `
...
console.log('Inline const widget components with JSX. Size:', c.length);
